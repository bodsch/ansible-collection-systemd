...
class SystemdUnitFile(object):
    ...
    def run(self):
        ...
        self.module.log(msg=f"state: {self.state}")
        self.module.log(msg=f"drop_ins: {self.drop_ins}")
        self.module.log(msg=f"unit_file: {self.unit_file}")
        ...
        if self.state == "absent":
            ...
            if isinstance(self.unit_file, dict) and len(self.unit_file) > 0:
                ...
                self.service_name = f"/lib/systemd/system/{self.name}.{self.unit_type}"
    ...
    def create_unit_file(self, data):
        ...
        file_temporary = os.path.join(self.tmp_directory, self.name)
